...
# retrieving SRR1411276 K-12 derivative BW38028 SRA transcriptomic project reads & E. coli K-12 substr. MG1655 complete genome
...
print('INFO: Attempting to download E. coli K-12 substr. MG1655 complete genome.\n')
handle = Entrez.efetch(db='nucleotide', id='NC_000913', rettype='fasta', retmode='text')
record = handle.read()
with open(current_dir+'/NC_000913.fa', 'w') as outfile:
    outfile.write(record.rstrip('\n'))
if os.path.isfile(current_dir+'/NC_000913.fa'):
    print('INFO: E. coli K-12 substr. MG1655 complete genome successfully downloaded.\n')
else:
    print('INFO: Could not download E. coli K-12 substr. MG1655 complete genome. Check if the accession number provided is correct.\n')
    exit()

print('INFO: Attempting to index E. coli K-12 substr. MG1655 complete genome using Bowtie.\n')
os.system('bowtie-build '+current_dir+'/NC_000913.fa NC_000913')
if os.path.isfile(current_dir+'/NC_000913.1.ebwt') and os.path.isfile(current_dir+'/NC_000913.2.ebwt') and os.path.isfile(current_dir+'/NC_000913.3.ebwt') and os.path.isfile(current_dir+'/NC_000913.4.ebwt') and os.path.isfile(current_dir+'/NC_000913.rev.1.ebwt') and os.path.isfile(current_dir+'/NC_000913.rev.2.ebwt'):
    print('INFO: E. coli K-12 substr. MG1655 complete genome successfully indexed.\n')
else:
    print('INFO: Could not index E. coli K-12 substr. MG1655 complete genome. Check if input file exists or Bowtie is correctly installed.\n')
    exit()

# mapping transcriptomic reads to reference genome & quantifying expression
print('INFO: Attempting to map SRR1411276 K-12 derivative BW38028 SRA transcriptomic project reads to the E. coli K-12 substr. MG1655 complete genome.\n')
...
print('INFO: Attempting to map quantify expression of mapped reads using Cufflinks.\n')
...
if os.path.isfile(results_dir+'/transcriptome_data.fpkm'):
    print('INFO: Cufflinks output succcessfully summarized.\n')
